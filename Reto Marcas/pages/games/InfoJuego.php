...
<body>
    ...
    <div class="container">
        <nav>
            ...
            <ul>
                ...
                <li>
                    ...
                    <span>
                        <a href="../../libreria.html">Biblioteca</a>
                    </span>
                </li>
				...
				<li>
                    ...
                    <span><a href="../../captchaLog.html">Iniciar sesión</a></span>
                </li>
				<li>
        ...
        <?php
        try {
    // Obtener el código del juego seleccionado desde la URL
    $codigoJuego = isset($_GET['codigoJuego']) ? $_GET['codigoJuego'] : null;

    // Validar que se proporcionó un código de juego
    if (!$codigoJuego) {
    ...
    // Pasar el código del juego al archivo XSLT como un parámetro
    $processor->setParameter('', 'codigoJuego', $codigoJuego);
